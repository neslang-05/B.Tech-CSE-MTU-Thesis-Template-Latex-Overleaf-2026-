...
% ---- RELATIONSHIPS ----
\draw[relation] (users) -- node[left]{\scriptsize 1:1} (profiles);
\draw[relation] (profiles) -- (roles);
...
\draw[relation] (actions) -- node[above, pos=0.35]{\scriptsize 1:N} (audit);
\draw[relation] (audit) -- node[above]{\scriptsize 1:N} (tokens);
