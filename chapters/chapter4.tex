...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/Paddy-seed.jpeg}
    \caption{Sample images collected from ICAR Manipur.}
    \label{fig:icar_dataset_samples}
\end{figure}
\newpage
...
The observations in Table~\ref{tab:training_behaviour} show that the training process was stable and effective. The model converged quickly, maintained high accuracy throughout training, and exhibited a small gap between training and validation performance. Early stopping further helped preserve the best-performing model while minimizing the risk of overfitting.
